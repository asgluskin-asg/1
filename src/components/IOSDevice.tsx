...
/** iPhone bezel, status bar and home indicator. Purely chrome around the app. */
...
function StatusBar() {
  ...
  return (
    ...
    >
      <div style={{ flex: 1, display: 'flex', justifyContent: 'center', paddingTop: 1.5 }}>
        <span style={{ fontFamily: '-apple-system, system-ui', fontWeight: 590, fontSize: 17, lineHeight: '22px', color: c }}>
          9:41
        </span>
      </div>
